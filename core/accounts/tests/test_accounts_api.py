...
@pytest.fixture
def user(db):
    return User.objects.create_user(email="user@example.com",password="@#123456",is_verified=True)
...
class TestJWTAuth:
    ...
    def test_jwt_refresh(self,api_client,user):
        ...
        response = api_client.post(create_url, {'email':'user@example.com', 'password': '@#123456'},format='json')
